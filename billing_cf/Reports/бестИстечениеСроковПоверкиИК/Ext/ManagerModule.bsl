...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ИстечениеСроковПоверкиИК");
	НастройкиВарианта.Описание = НСтр("ru = 'Истечение сроков поверки ИК (ЮЛ)'"); 
