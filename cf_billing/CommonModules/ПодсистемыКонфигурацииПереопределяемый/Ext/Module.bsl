...
Процедура ПриДобавленииПодсистем(МодулиПодсистем) Экспорт
	...
	МодулиПодсистем.добавить("ОбновлениеИнформационнойБазыБиллинг");
	
	МодулиПодсистем.добавить("ОбновлениеИнформационнойБазыБПО");
	
	МодулиПодсистем.добавить("ОбновлениеИнформационнойБазыБФП");
	
	МодулиПодсистем.добавить("бестОбновлениеИнформационнойБазыБиллинг");
	
	Если ОбщегоНазначения.ПодсистемаСуществует("скэкПроект") Тогда
		МодулиПодсистем.добавить("скэкОбновлениеИнформационнойБазыБиллинг");
	КонецЕсли;	
	
	Если ОбщегоНазначения.ПодсистемаСуществует("энргГИСЖКХ") Тогда
		МодулиПодсистем.добавить("энргГИСЖКХОбновлениеИнформационнойБазы");
	КонецЕсли;
	
	Если ОбщегоНазначения.ПодсистемаСуществует("рксПроект") Тогда
		МодулиПодсистем.добавить("рксОбновлениеИнформационнойБазыБиллинг");
	КонецЕсли;
