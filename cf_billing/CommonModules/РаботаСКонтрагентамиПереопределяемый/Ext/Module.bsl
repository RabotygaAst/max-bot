...
Процедура ДополнитьРеквизитыФормыКонтрагент(Форма, НовыеРеквизиты) Экспорт
	...
	Если Форма.ИмяФормы = "Справочник.энргКонтрагенты.Форма.ФормаЭлемента" Тогда
		
		ЮрФизЛицо = Форма.Объект.ЮрФизЛицо;
		
		НовыеРеквизиты.ЭтоИностранныйКонтрагент = (ЮрФизЛицо = Перечисления.бестЮрФизЛицо.ЮрЛицоНеРезидент);
		НовыеРеквизиты.ЭтоЮридическоеЛицо =  (ЮрФизЛицо = Перечисления.бестЮрФизЛицо.ЮрЛицо Или ЮрФизЛицо = Перечисления.бестЮрФизЛицо.ЮрЛицоНеРезидент);
