...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	Если ИдентификаторНастройки = "ТолькоПолучение" Тогда
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Позволяет получать данные из программы ""1С:Управление теплосетью"". 
		|Принимаются следующие типы данных: справочники (например, ""Организации, Нежилые помещения""), документы (например, ""Начисление"")'");
	ИначеЕсли ИдентификаторНастройки = "Двухсторонний" Тогда
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Позволяет синхронизировать данные с программами ""1С:Управление теплосетью"". 
	...
	ПодробнаяИнформацияПоОбмену = ?(ОбщегоНазначения.РазделениеВключено(),
		...
		"ПланОбмена.ОбменБиллингУправлениеТеплосетью.Форма.ПодробнаяИнформация");
	...
	ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента = НСтр("ru = '1С:Управление теплосетью'");
	...
	Если ИдентификаторНастройки = "ТолькоПолучение" Тогда
		...
		ЗаголовокКоманды   = НСтр("ru = 'Получение данных из ""1С:Управление теплосетью""'");
		ЗаголовокПомощника = НСтр("ru='Получение данных из 1С:Управление теплосетью (настройка)'");
		ЗаголовокУзла      = НСтр("ru='Получение данных из 1С:Управление теплосетью'");
		
	ИначеЕсли ИдентификаторНастройки = "Двухсторонний" Тогда
		
		ЗаголовокКоманды   = НСтр("ru = 'Полная синхронизация данных с ""1С:Управление теплосетью""'");
		ЗаголовокПомощника = НСтр("ru='Синхронизация данных с 1С:Управление теплосетью (настройка)'");
		ЗаголовокУзла      = НСтр("ru='Синхронизация данных с 1С:Управление теплосетью'");
...
Функция ПредставлениеОтбораИнтерактивнойВыгрузки(Получатель, Параметры) Экспорт
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Будут отправлены начисления абонентов %1,
		         |%2'"),
...
Функция ПараметрыВыгрузкиПоУмолчанию(Получатель)
	...
	Результат.Вставить("ПредставлениеОтбора", СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Будут отправлены начисления абонентов по организациям:
		         |%1'"),
		ОтборПоОрганизацииСтрокой));
