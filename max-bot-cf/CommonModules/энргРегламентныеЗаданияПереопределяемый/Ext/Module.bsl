...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Настройки) Экспорт
	...
	//Настройка = Настройки.Добавить();
	//Настройка.РегламентноеЗадание = Метаданные.РегламентныеЗадания.пвиЗагрузитьПоказанияИзВнешнейСистемы;
	//Настройка.РаботаетСВнешнимиРесурсами = Истина;
	//Настройка.Параметризуется 			 = Истина;	
	//
	//Настройка = Настройки.Добавить();
	//Настройка.РегламентноеЗадание = Метаданные.РегламентныеЗадания.пвиОбновитьТокенДоступаДляСинхронизацииСРоботом;
	//Настройка.РаботаетСВнешнимиРесурсами = Истина;
	//Настройка.Параметризуется 			 = Истина;	
	//
	//Настройка = Настройки.Добавить();
	//Настройка.РегламентноеЗадание = Метаданные.РегламентныеЗадания.пвиОбработатьДанныеВнешнейСистемыВБазе;
	//Настройка.РаботаетСВнешнимиРесурсами = Истина;
	//Настройка.Параметризуется 			 = Истина;	
	//
	//Настройка = Настройки.Добавить();
	//Настройка.РегламентноеЗадание = Метаданные.РегламентныеЗадания.пвиСконвертироватьДанныеСРегистраВДокумент;
	//Настройка.РаботаетСВнешнимиРесурсами = Истина;
	//Настройка.Параметризуется 			 = Истина;	
	//
КонецПроцедуры
